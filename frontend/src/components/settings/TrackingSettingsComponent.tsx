    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="space-y-6">
        <div className="relative group">
          <div className="absolute -inset-1 bg-gradient-to-r from-primary/20 to-purple-500/20 rounded-3xl blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
          <div className="relative bg-muted/30 p-8 rounded-3xl border border-border/50">
            <div className="flex items-center justify-between mb-6">
              ...
              <Button 
                variant="ghost" 
                size="sm" 
                className="h-8 px-4 text-[10px] font-black gap-2 bg-background/50 hover:bg-background shadow-sm border border-border/40 transition-all rounded-lg"
                onClick={handleCopy}
              >
            ...
            <pre className="text-[13px] font-mono text-foreground overflow-x-auto leading-relaxed selection:bg-primary/20 p-4 rounded-xl bg-slate-900/5 dark:bg-slate-900/50 border border-border/20">
        ...
        <div className="grid gap-6">
           ...
           <div className="flex gap-4 p-6 rounded-3xl bg-muted/30 border border-border/50">
              <div className="w-10 h-10 rounded-xl bg-muted/20 flex items-center justify-center border border-border/50 shrink-0">
