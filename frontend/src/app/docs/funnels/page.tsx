    ...
    return (
        <div className="space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-muted/30 rounded border p-8 space-y-4 flex flex-col justify-center">
                    <div className="space-y-2">
                        <div className="w-full bg-primary/20 h-10 rounded flex items-center justify-between px-4 border border-primary/20">
                            <span className="text-xs font-medium">1. Landing Page</span>
                            <span className="text-xs font-bold text-primary">100%</span>
                        </div>
                        <div className="w-[85%] bg-primary/20 h-10 rounded flex items-center justify-between px-4 border border-primary/20">
                            <span className="text-xs font-medium">2. Pricing View</span>
                            <span className="text-xs font-bold text-primary">85%</span>
                        </div>
                        <div className="w-[45%] bg-primary/20 h-10 rounded flex items-center justify-between px-4 border border-primary/20">
            ...
            <section className="space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    <div className="p-6 rounded bg-card border">
            ...
            <section className="p-8 rounded border bg-card/50 relative overflow-hidden">
