        ...
        <div className="flex h-dvh max-h-dvh min-h-0 flex-col overflow-hidden bg-background lg:flex-row">
            ...
            <div className="hidden min-h-0 overflow-y-auto bg-muted/40 lg:flex lg:w-1/2 lg:flex-col lg:justify-center lg:rounded-r-3xl lg:border-y lg:border-r lg:border-border/50 dark:bg-muted/15">
                <div className="px-12 py-10 xl:px-16">
                    ...
                    <h1 className="font-headline mb-3 max-w-3xl text-3xl font-semibold leading-tight tracking-tight text-foreground md:text-[1.75rem]">
                        {enterpriseAuthMarketing.headline}
                    </h1>
                    <p className="mb-8 max-w-xl text-sm leading-relaxed text-muted-foreground">
                        {enterpriseAuthMarketing.signinSubhead}
                    </p>
                ...
                <div className="mx-auto w-full max-w-md lg:max-w-lg">
                    <div className="mb-5 space-y-3 text-center lg:hidden">
                        ...
                        <div className="mx-auto max-w-sm px-1 py-1 text-left">
                            ...
                            <p className="mt-1 text-xs leading-snug text-muted-foreground">{enterpriseAuthMarketing.signinSubhead}</p>
                    ...
                    <div className="mb-6 sm:mb-7">
                        <h2 className="mb-1 font-headline text-2xl font-semibold tracking-tight text-foreground sm:text-[1.625rem]">Welcome back</h2>
                        <p className="text-sm leading-relaxed text-muted-foreground sm:text-[0.9375rem]">Sign in to your account to continue.</p>
                    </div>
                    ...
                    <div className="mb-5 space-y-2.5">
                        <button
                            ...
                            className="flex h-12 w-full items-center justify-center gap-2.5 rounded-lg shadow-sm  bg-white text-sm font-medium text-gray-800 transition-colors hover:bg-gray-50"
                        >
                        ...
                        <button
                            ...
                            className="flex h-12 w-full items-center justify-center gap-2.5 rounded-lg border border-transparent bg-[#24292f] text-sm font-medium text-white transition-colors hover:bg-[#2f363d]"
                        >
                    ...
                    <>
                        ...
                        <form onSubmit={handleEmailSignIn} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <label htmlFor="signin-email" className="block text-sm font-medium text-foreground">Email</label>
