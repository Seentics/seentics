...
export default function QuickStart() {
    ...
    return (
        <div className="space-y-12">
            ...
            <div className="p-8 rounded-lg bg-primary text-white text-center space-y-4 overflow-hidden relative">
                <div className="relative z-10">
                    <h2 className="text-2xl font-bold">You're all set!</h2>
                    <p className="text-primary-foreground/90 font-medium">Ready to explore deep insights?</p>
                    <div className="pt-4">
                        <Link href="/websites" className="px-8 py-3 bg-white text-primary rounded-lg font-bold hover:bg-opacity-90 transition inline-block">
                            Go to Dashboard
                        </Link>
                    </div>
                </div>
