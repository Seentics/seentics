    ...
    return (
        <div className="space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-muted/30 rounded-lg border p-8 space-y-4 flex flex-col justify-center">
                    <div className="space-y-2">
                        ...
                        <div className="w-[12%] bg-indigo-500/40 h-10 rounded-lg flex items-center justify-between px-4 border border-indigo-500/40">
            ...
            <section className="p-8 rounded-lg border bg-card/50 relative overflow-hidden">
