                            ...
                            <DropdownMenuContent align="end" className="w-52 bg-card/98 backdrop-blur-xl border-border/40 shadow-2xl p-1">
                                <DropdownMenuItem asChild className="cursor-pointer rounded-md focus:bg-primary/5">
                                    <Link href={`/websites/${websiteId}/automations/builder?id=${auto.id}`} className="flex items-center gap-3 w-full py-2.5 px-3">
                                        <div className="h-8 w-8 rounded-lg bg-indigo-500/10 flex items-center justify-center"><Edit className="h-4 w-4 text-indigo-500" /></div>
            ...
            >
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-60 bg-card/98 backdrop-blur-xl border-border/40 shadow-2xl p-1.5">
                        ...
                        <DropdownMenuItem asChild className="cursor-pointer rounded-md focus:bg-indigo-500/5 p-0 mt-0.5">
