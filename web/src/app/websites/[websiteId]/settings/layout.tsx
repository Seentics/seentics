...
export default function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className={cn(websiteWorkspaceShellClass, 'flex flex-col gap-6 pb-12')}>
            ...
            {visibleLinks.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    'flex items-center gap-2 px-3 py-1.5 text-sm font-medium rounded-md transition-all shrink-0',
                    active
