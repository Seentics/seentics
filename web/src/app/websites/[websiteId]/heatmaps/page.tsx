      ...
      cell: ({ row }) => (
        <div className="flex flex-col items-center gap-1">
          ...
          <div className="h-1 w-12 bg-muted/60 rounded-full overflow-hidden">
            <div className="h-full bg-indigo-500/60 rounded-full" style={{ width: `${Math.min(100, (row.original.views / maxViews) * 100)}%` }} />
          </div>
        </div>
      ),
    },
    {
      ...
      cell: ({ row }) => (
        <div className="flex flex-col items-center gap-1">
          ...
          <div className="h-1 w-12 bg-muted/60 rounded-full overflow-hidden">
            <div className="h-full bg-indigo-500/60 rounded-full" style={{ width: `${Math.min(100, (row.original.clicks / maxClicks) * 100)}%` }} />
          </div>
        </div>
      ),
    },
