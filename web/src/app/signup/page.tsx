                        ...
                        {step === 1 ? (
                            <div key="account">
                                <div className="mb-8">
                                    ...
                                    <p className="text-sm text-muted-foreground">Start tracking for free in minutes.</p>
                                </div>
                            ...
                            <div key="website">
                                <div className="mb-8">
                                    <h2 className="text-2xl font-bold tracking-tight text-foreground mb-1">Add your website</h2>
                                    <p className="text-sm text-muted-foreground">Connect your first domain to start tracking.</p>
                                </div>
                                ...
                                <form onSubmit={handleWebsiteSubmit} className="space-y-4">
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-xs font-medium text-muted-foreground">Website Name</label>
                                        <div className="relative">
                                    ...
                                    >
                                        {isLoading ? <Loader2 className="animate-spin h-4 w-4" /> : (
                                            <span className="flex items-center gap-2">
                                                Finalize setup <ArrowRight size={14} />
                                            </span>
                                        )}
                                    </Button>
                                </form>
