    ...
    const templates: Record<string, any> = {
      ...
      'exit-intent-promotion': {
        ...
        nodes: [
          ...
          { id: 'a1', type: 'actionNode', data: { label: 'Offer Banner', config: { actionType: 'banner', content: 'Wait! Use code SAVE20 for 20% off your first order! 🏷️', backgroundColor: '#5243f4', position: 'top' } }, position: { x: 250, y: 300 } }
        ],
        edges: [{ id: 'e1-2', source: 't1', target: 'a1', animated: true }]
      },
      'scroll-depth-banner': {
