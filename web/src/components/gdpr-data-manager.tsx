...
export default function GDPRDataManager({ userId, userEmail }: GDPRDataManagerProps) {
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      ...
      processing: { color: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/20 dark:text-indigo-400', icon: Settings },
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-slate-600 dark:text-slate-400">
              ...
              <p className="mt-1">
                ...
                <a href="mailto:dpo@seentics.com" className="text-indigo-600 hover:underline">
                  dpo@seentics.com
                </a>
              </p>
            </div>
