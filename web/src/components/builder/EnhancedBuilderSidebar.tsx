                ...
                <>
                  ...
                  {customTriggers.map((trigger) => (
                    <div
                      ...
                      className="group relative cursor-move p-3 rounded-xl border-2 border-slate-800 hover:border-indigo-500/40 bg-slate-900/60 hover:bg-slate-900 transition-all duration-200"
                    >
