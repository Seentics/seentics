  ...
  return (
    <div className="flex h-full bg-background">
      ...
      >
        ...
        <div className="absolute bottom-4 left-1/2 z-10 flex -translate-x-1/2 gap-1.5 rounded-lg border border-border/60 bg-card/90 p-1.5 shadow-xl backdrop-blur-md">
