...
export default function MapWrapper({ data, className = '' }: MapWrapperProps) {
  ...
  if (!mapComponent) {
    return (
      <div className={`h-[32rem] bg-gradient-to-br from-indigo-50 to-green-50 dark:from-indigo-950/20 dark:to-green-950/20 rounded flex items-center justify-center ${className}`}>
