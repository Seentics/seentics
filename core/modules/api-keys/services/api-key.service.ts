 ...
 *
 * This module owns the API-key lifecycle and its table. The raw data HTTP adapter uses
 * only the verifier interface exposed by the module.
 *
 * ─── What a key is ──────────────────────────────────────────────────────────────
 *
...
import type { ApiScope } from "../interfaces";

export { API_SCOPES, SCOPE_DESCRIPTIONS, type ApiScope } from "../interfaces";
