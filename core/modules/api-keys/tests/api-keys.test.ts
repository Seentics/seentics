...
let createApiKeyRoutes: typeof import("../routes").createApiKeyRoutes;
let API_SCOPES: typeof import("../services/api-key.service").API_SCOPES;

beforeAll(async () => {
  ({ createApiKeyRoutes } = await import("../routes"));
  ({ API_SCOPES } = await import("../services/api-key.service"));
});
