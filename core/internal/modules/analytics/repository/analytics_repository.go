...
func (r *PostgresAnalyticsRepository) GetDashboardMetrics(ctx context.Context, websiteID string, days int, filters models.AnalyticsFilters) (*models.DashboardMetrics, error) {
	return r.dashboard.GetDashboardMetrics(ctx, websiteID, days, filters)
}

func (r *PostgresAnalyticsRepository) GetComparisonMetrics(ctx context.Context, websiteID string, days int, filters models.AnalyticsFilters) (*models.ComparisonMetrics, error) {
...
func (r *PostgresAnalyticsRepository) GetTopPages(ctx context.Context, websiteID string, days int, limit int) ([]models.PageStat, error) {
	return r.topPages.GetTopPages(ctx, websiteID, days, limit)
}

func (r *PostgresAnalyticsRepository) GetTopPagesWithTimeBucket(ctx context.Context, websiteID string, days int, limit int) ([]models.PageStat, error) {
...
func (r *PostgresAnalyticsRepository) GetTopReferrers(ctx context.Context, websiteID string, days int, limit int) ([]models.ReferrerStat, error) {
	return r.topReferrers.GetTopReferrers(ctx, websiteID, days, limit)
}

// Top Sources Analytics Methods
func (r *PostgresAnalyticsRepository) GetTopSources(ctx context.Context, websiteID string, days int, limit int) ([]models.SourceStat, error) {
	return r.topSources.GetTopSources(ctx, websiteID, days, limit)
}

// Top Countries Analytics Methods
func (r *PostgresAnalyticsRepository) GetTopCountries(ctx context.Context, websiteID string, days int, limit int) ([]models.CountryStat, error) {
	return r.topCountries.GetTopCountries(ctx, websiteID, days, limit)
}

// Top Browsers Analytics Methods
func (r *PostgresAnalyticsRepository) GetTopBrowsers(ctx context.Context, websiteID string, days int, limit int) ([]models.BrowserStat, error) {
	return r.topBrowsers.GetTopBrowsers(ctx, websiteID, days, limit)
}

// Top Devices Analytics Methods
func (r *PostgresAnalyticsRepository) GetTopDevices(ctx context.Context, websiteID string, days int, limit int) ([]models.DeviceStat, error) {
	return r.topDevices.GetTopDevices(ctx, websiteID, days, limit)
}

// Top OS Analytics Methods
func (r *PostgresAnalyticsRepository) GetTopOS(ctx context.Context, websiteID string, days int, limit int) ([]models.OSStat, error) {
	return r.topOS.GetTopOS(ctx, websiteID, days, limit)
}

// Traffic Summary Analytics Methods
func (r *PostgresAnalyticsRepository) GetTrafficSummary(ctx context.Context, websiteID string, days int) (*models.TrafficSummary, error) {
...
func (r *PostgresAnalyticsRepository) GetVisitorInsights(ctx context.Context, websiteID string, days int) (*models.VisitorInsights, error) {
	return r.visitorInsights.GetVisitorInsights(ctx, websiteID, days)
}

// Activity Trends Analytics Methods
func (r *PostgresAnalyticsRepository) GetActivityTrends(ctx context.Context, websiteID string) (*models.ActivityTrendsResponse, error) {
