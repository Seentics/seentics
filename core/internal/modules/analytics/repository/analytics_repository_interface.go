...
type MainAnalyticsRepository interface {
	...
	GetTopPages(ctx context.Context, websiteID string, days int, timezone string, limit int) ([]models.PageStat, error)
	...
	GetTopReferrers(ctx context.Context, websiteID string, days int, timezone string, limit int) ([]models.ReferrerStat, error)
	GetTopSources(ctx context.Context, websiteID string, days int, timezone string, limit int) ([]models.SourceStat, error)
	GetTopCountries(ctx context.Context, websiteID string, days int, timezone string, limit int) ([]models.CountryStat, error)
	GetTopBrowsers(ctx context.Context, websiteID string, days int, timezone string, limit int) ([]models.BrowserStat, error)
	GetTopDevices(ctx context.Context, websiteID string, days int, timezone string, limit int) ([]models.DeviceStat, error)
	GetTopOS(ctx context.Context, websiteID string, days int, timezone string, limit int) ([]models.OSStat, error)
