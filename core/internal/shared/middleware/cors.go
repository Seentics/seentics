...
func CORSMiddleware(allowedOrigins string) gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		c.Writer.Header().Set("Access-Control-Allow-Headers", "Content-Type, Content-Length, Accept-Encoding, Content-Encoding, X-CSRF-Token, Authorization, accept, origin, Cache-Control, X-Requested-With, X-API-Key, X-Site-ID")
