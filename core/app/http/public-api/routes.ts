...
import { createRawApiAuthMiddleware, requireScope } from "./raw-api-auth";
import type { ApiKeyVerifier } from "../../../modules/api-keys/interfaces";
...
const r = new Hono();
const rawApiAuthMiddleware = createRawApiAuthMiddleware(deps.apiKeys);
